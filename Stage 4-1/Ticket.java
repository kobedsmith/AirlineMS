...
public class Ticket {
    ...
    public double getCreatedTicketPrice(Ticket ticket, double price) {
        if (classType.equalsIgnoreCase(ticket.getClassType())) {
            return price;
        } else {
            System.out.println("This ticket is not a ticket type! Please try again.");
            return 0.0;
    ...
    public String getCreatedTicketID(Ticket ticket) {
        if (classType.equalsIgnoreCase(ticket.getClassType())) {
            ticketID = "NEW-" + passengerPnr;
            return ticketID;
        } else {
            System.out.println("This ticket is not a ticket type! Please try again.");
            return "N/A";
