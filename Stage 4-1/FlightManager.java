...
public class FlightManager extends Staff{
    ...
    //2 new ArrayLists added to manage purchased tickets and new passengers.
    private ArrayList<Ticket> purchasedTicketList = new ArrayList<>();
    private ArrayList<Passenger> newPassengerList = new ArrayList<>();
