...
public class Passenger {
     ...
     */
    public void buyTicket(PaymentProcessor paymentProcessor, Passenger passenger, Payment payment, NumTickets numTickets, TicketManager ticketManager, 
        Ticket ticket, String status, double amount, Flight flight, FlightManager flightManager) {
        System.out.println(name + " is purchasing " + numTickets.getQuantity() + " ticket(s)...");
        paymentProcessor.processPayment(payment, amount, passenger, status);
     ...
     * @param paymentProcessor
     */
    public void requestRefund(PaymentProcessor paymentProcessor, Passenger passenger, Payment payment, double refund, NumTickets numTickets, TicketManager ticketManager, 
        Ticket ticket, String status, double amount, Flight flight, FlightManager flightManager) {
        System.out.println(name + " is requesting a refund...");
        paymentProcessor.processRefund(payment, amount, passenger, refund, status);
