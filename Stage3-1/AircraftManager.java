...
public class AircraftManager extends Staff{
     ...
     * @param aircraftList
     */
    public AircraftManager(String name, int age, int staffID, String email, String workNumber, String department, int salary) {
        super(name, age, staffID, email, workNumber, department = "Aircraft Management", salary);
    }

    public AircraftManager() {
        super("Default Aircraft Manager", 0, 0, "", "", "Aircraft Management", 0);
    }
