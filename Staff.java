...
public class Staff {
    ...
    * @param department
    */
    public Staff(String name, int age, int staffID, String email, String workNumber, String department) {
        this.name = name;
        this.age = age;
    ...
    public String getInfo() {
        return "Department: " + department + " - Name: " + name + " - Age: " + age + " - Staff ID: " + staffID + " - Email: " + email + " - Work Number: " + workNumber;
    }
